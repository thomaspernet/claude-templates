...
2. **Update `project-specific/` as part of every PR** that changes the topic area. If you add a data pipeline, update the pipeline docs. If you change a table schema, update the data docs. Documentation updates are not optional — the work is incomplete without them.
